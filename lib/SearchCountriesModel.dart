...
//
//     final searchCountries = searchCountriesFromJson(jsonString);
...
List<SearchCountries> searchCountriesFromJson(String str) =>
    List<SearchCountries>.from(
        json.decode(str).map((x) => SearchCountries.fromJson(x)));

String searchCountriesToJson(List<SearchCountries> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

String searchCountriesSingleToJson(SearchCountries data) =>
...
Future<ApiResponse> getSearchCountries(String query) async {
  ApiResponse cp = await ApiHelper()
      .getReq(endpoint: "https://restcountries.eu/rest/v2/name/", query: query);
  return cp;
}
