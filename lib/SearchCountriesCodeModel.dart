...
//
//     final searchCountriesCode = searchCountriesCodeFromJson(jsonString);
...
SearchCountriesCode searchCountriesCodeFromJson(String str) =>
    SearchCountriesCode.fromJson(json.decode(str));

String searchCountriesCodeToJson(SearchCountriesCode data) =>
    json.encode(data.toJson());

class SearchCountriesCode {
  SearchCountriesCode({
    this.name,
    this.topLevelDomain,
    this.alpha2Code,
  ...
  factory SearchCountriesCode.fromJson(Map<String, dynamic> json) =>
      SearchCountriesCode(
        name: json["name"],
        ...
        area: json["area"],
        gini: json["gini"] == null ? 1.0 : json["gini"].toDouble(),
...
Future<ApiResponse> getCodeCountries(String query) async {
  ApiResponse cp = await ApiHelper().getReq(
      endpoint: "https://restcountries.eu/rest/v2/alpha/", query: query);
  return cp;
}
